Materials used to build this app:

1. [How to fetch data with React Hooks?](https://www.robinwieruch.de/react-hooks-fetch-data)
2. [mapbox-gl from uber](https://uber.github.io/react-map-gl/docs/advanced/viewport-transition)
...
7. [Table from material-ui](https://material-ui.com/components/tables/)